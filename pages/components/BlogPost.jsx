...
const BlogPost = () => {
  return (
    <div className="flex flex-col gap-2 cursor-pointer transition-all" >
      <div>
      ...
      <h2 className="font-type font-semibold text-2xl hover:text-main " >MOBILE GAMING IS FUTURE</h2>
